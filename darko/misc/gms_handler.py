...
def solve_high_level(gams_folder, sim_folder, gams_file='DARKO.gms', result_file='Results.gdx', output_lst=False):
...
def solve_low_level(gams_folder, sim_folder, gams_file='DARKO.gms', result_file='Results.gdx', output_lst=False,
                    logoption=3):
