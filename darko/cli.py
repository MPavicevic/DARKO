...
@click.version_option(prog_name='DARKO', version=__version__)
@click.pass_context
def cli(ctx, config):
    """Build and run the DARKO model according to a config file.
     E.g. darko -c ./ConfigFiles/ConfigTest.xlsx build simulate
    """
